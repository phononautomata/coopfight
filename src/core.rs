...
pub fn dynamical_loop(agent_ensemble: &mut AgentEnsemble, pars_model: &Input) -> Output {
    ...
    while t < t_total {
        ...
        for focal_agent in 0..nagents {
            ...
            for focal_neighbor in &focal_neighbors {
                agent_ensemble.inner_mut()[*focal_neighbor].resources_instant = 0.0;
    ...
    let nagents_f64 = nagents as f64;
    let t_average_f64 = (t_total - t_equilibrium) as f64;

    let output_global = OutputGlobal {
        fraction_cooperators: avg_fraction_cooperators / (t_average_f64 * nagents_f64),
        fraction_defectors: avg_fraction_defectors / (t_average_f64 * nagents_f64),
        fraction_fighters: avg_fraction_fighters / (t_average_f64 * nagents_f64),
        payoff_cooperators: avg_payoff_cooperators / (t_average_f64 * nagents_f64),
        payoff_defectors: avg_payoff_defectors / (t_average_f64 * nagents_f64),
        payoff_fighters: avg_payoff_fighters / (t_average_f64 * nagents_f64),
    };
